-- Migration 00085: Rename "Missing COGS" label in data_quality_issues
-- "Missing COGS" is jargon. Replacing with "No product cost" (plain English).
-- No schema change — view logic is identical.
